...
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', 'https://alagarclinic.5ytechno.com');
...
// Endpoint to handle incoming messages from the chatbot UI
app.post('/chatbot', (req, res) => {
  const userMessage = req.body.message; // Assuming message is sent in the body
  
  // Replace this logic with your actual chatbot implementation
  const botResponse = generateResponse(userMessage);
  
  // Simulating delay for a more realistic interaction
  setTimeout(() => {
...
// Function to generate a response (Replace this with your actual chatbot logic)
function generateResponse(message) {
  // Basic mock logic, replace this with your AI/NLP logic
